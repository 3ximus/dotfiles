...
if hash nativefier &>/dev/null ; then
	...
	nativefier --inject $theme_path --inject /tmp/whatsapp-inject.js --icon "./icons/whatsapp.png" --name whatsapp --counter --single-instance --user-agent "Mozilla/5.0 (X11; Linux x86_64; rv:144.0) Gecko/20100101 Firefox/144.0" web.whatsapp.com /tmp/whatsapp
