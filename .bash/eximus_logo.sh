...
# highlight_color=255
# bottom_light=235
# exi_color=$upper_color
# mus_color=245

# if [ `whoami` == "eximus" ] ;then
...
# 			s/exi/$(echo -e "\033[1;38;5;${exi_color}m&")/g
# 			s/mus/$(echo -e "\033[1;38;5;${mus_color}m&")/g"
# fi

# printf "$(cat ~/.bash/greet/eximus_iso.txt)"
